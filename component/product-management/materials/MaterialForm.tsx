...
export default function MaterialForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      console.log("Material Data Saved Successfully:", payload);
    ...
    <Box sx={{ p: 3, background: "#F8FAFC", minHeight: "100vh" }}>
      ...
      >
        ...
        <Typography sx={{ color: "#64748B", mb: 4, fontSize: "14px" }}>
          Add material details linked with brand, brand group, category, pricing, and stock information.
        </Typography>
          ...
          <form onSubmit={formik.handleSubmit}>
            <Grid container spacing={1}>
              <FormSection
                ...
                description="Add material identity, category, brand group, and applicable product type."
              >
                {[
              ...
              <FormSection
                ...
                description="Add purchase, selling price, tax, and HSN code."
              >
                {[
              ...
              <FormSection
                ...
                description="Manage stock quantity, minimum level, warehouse, and supplier."
              >
                {[
              ...
              <FormSection
                ...
                description="Add description, notes, and modification information."
              >
                <Grid size={{ xs: 12 }}>
                  <TextField
                    fullWidth
